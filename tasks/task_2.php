<?php
$arrOut = array(
    "first heading" => "<h2>Privacy</h2>",
    "first text " => "<p class=\"mb-g\">Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
